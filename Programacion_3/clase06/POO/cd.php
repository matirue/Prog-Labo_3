<?php
//siempre q trabajo con una tablad de base de datos tengo q generar una clase q la maneje
//en este caso esta clase maneja la bd de cdcol.sql
class cd
{
    public $id;
    public $titulo;
