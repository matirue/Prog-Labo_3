...
switch ($queMuestro) {
    ...
    case "conexionBasica":
        ...
        try {
            ...
            $usuario='root';//datos mios, si uso un host externo uso los usuarios y clave q me dan
            $clave='';

            $objetoPDO = new PDO('mysql:host=localhost;dbname=cdcol;charset=utf8', $usuario, $clave);

            
            //sting de conexion, localhost por ahora, cuando esusemos un host externo uso la direccion del host
    ...
    case "query_fetchAll":
        ...
        try {
            ...
            foreach ($resultado as $fila) {//puedo acceder a sus indice por fila o por columna
    ...
    case "query_fetchOject":
        ...
        try {
            ...
            //los atributos de la clase deben coincidir con el nombre de los valores de la BD (las columnas)
            $sql = $db->query('SELECT titel AS titulo, interpret AS interprete, jahr AS anio FROM cds');
    ...
    case "prepare":
        ...
        try {
            ...
            while($fila = $sentencia->fetch()){//OJO no es el fetchAll, en este caso ejecuta un fetch por cada fila
    ...
    case "prepareParam"://se analiza, se compila una sola vez y lo uso n veces
        ...
        try {
            ...
            //muestro la info del id que le paso
    ...
    case "bindParam":
        ...
        try {
            ...
            //CON PARAMETRO POSICIONAL                                                                               parametro posicional
            $sentencia = $pdo->prepare('SELECT titel AS titulo, interpret AS interprete, jahr AS anio FROM cds WHERE id = ?');
            $sentencia->bindParam(1,  $id, PDO::PARAM_INT);//id es la variable a la que voy a enlazar
    ...
    case "fetch_lazy"://lazy flojo, liviano
    ...
    case "fetch_into":
        ...
        require_once "../clases/cd.php";//le expecifico sobre que clase quiero q me me genere el objeto
